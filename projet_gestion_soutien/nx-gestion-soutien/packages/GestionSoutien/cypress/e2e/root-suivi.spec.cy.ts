describe('GestionSoutien', () => {
  ...
  it('root - suivi - first week (all uncheck)', () => {
  ...
  it('root - suivi - first week (GroupeA check only)', function () {
    cy.get('select#selec-sem').select('1');
    cy.get('div#grps_filtres')
      .find('input[type="checkbox"][value="GroupeA"]')
      .check();
  ...
  it('root - suivi - first week (GroupeB check only)', function () {
    cy.get('select#selec-sem').select('1');
    cy.get('div#grps_filtres')
      .find('input[type="checkbox"][value="GroupeA"]')
      .uncheck();
  ...
  it('root - suivi - first week (GroupeC check only)', function () {
    cy.get('select#selec-sem').select('1');
    cy.get('div#grps_filtres')
      .find('input[type="checkbox"][value="GroupeA"]')
      .uncheck();
  ...
  it('root - suivi - first week (GroupeD check only)', function () {
    cy.get('select#selec-sem').select('1');
    cy.get('div#grps_filtres')
      .find('input[type="checkbox"][value="GroupeA"]')
      .uncheck();
  ...
  it('root - suivi - compare two differents week', function () {
    cy.get('select#selec-sem').select('1');
    cy.get('div#grps_filtres')
      .find('input[type="checkbox"][value="GroupeA"]')
      .uncheck();
