...
public class MotMystere {
    ...
    /**
     * change le dictionnaire en fonction des bornes données
     * @param nomfic
     * @param mini
     * @param maxi
     */
    public void setDicoLong(String nomfic,int mini, int maxi){
        this.dict = new Dictionnaire(nomfic,mini,maxi);
    }
    /**
