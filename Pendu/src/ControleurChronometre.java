...
public class ControleurChronometre implements EventHandler<ActionEvent> {
    ...
    public ControleurChronometre (Chronometre chrono){
        this.tempsEcoule = 0;
        this.tempsPrec = -1;
         // le Chrono n’est pas encore lance
        this.chrono = chrono;
    }
    ...
    public void handle(ActionEvent actionEvent) {
        ...
        if (this.tempsPrec != -1){
        // calcul du tps ́ecoule depuis la derniere frame
        long tempEcoule = heureDuSysteme - this.tempsPrec;
        this.tempsEcoule += tempEcoule;
